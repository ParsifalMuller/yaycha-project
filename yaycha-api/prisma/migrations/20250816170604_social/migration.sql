/*
  ...
  - You are about to drop the column `create` on the `Comment` table. All the data in the column will be lost.
  - You are about to drop the column `create` on the `Post` table. All the data in the column will be lost.
